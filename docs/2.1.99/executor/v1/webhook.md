---
permalink: /2.1.99/executor/v1/webhook/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withPayloadObjectField(payloadObjectField)`](#fn-specwithpayloadobjectfield)
  * [`fn withPayloadTemplate(payloadTemplate)`](#fn-specwithpayloadtemplate)
  * [`fn withPayloadTemplateReference(payloadTemplateReference)`](#fn-specwithpayloadtemplatereference)
...
### fn spec.withPayloadObjectField

```ts
withPayloadObjectField(payloadObjectField)
```

"will load the generated payload for notification inside the object"

### fn spec.withPayloadTemplate

```ts
withPayloadTemplate(payloadTemplate)
```

"golang based template for notification payload"

### fn spec.withPayloadTemplateReference

```ts
withPayloadTemplateReference(payloadTemplateReference)
```
