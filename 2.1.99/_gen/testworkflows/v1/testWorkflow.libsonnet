{
  ...
  '#':: d.pkg(name='testWorkflow', url='', help='"TestWorkflow is the Schema for the workflows API"'),
  ...
  '#new':: d.fn(help='new returns an instance of TestWorkflow', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'testworkflows.testkube.io/v1',
    kind: 'TestWorkflow',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"TestWorkflow specification"'),
  spec: {
    ...
    after: {
      ...
      parallel: {
        ...
        '#template':: d.obj(help='"single template to run in this step"'),
        template: {
          '#withConfig':: d.fn(help='"trait configuration values if needed"', args=[d.arg(name='config', type=d.T.object)]),
          withConfig(config): { parallel+: { template+: { config: config } } },
          '#withConfigMixin':: d.fn(help='"trait configuration values if needed"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='config', type=d.T.object)]),
          withConfigMixin(config): { parallel+: { template+: { config+: config } } },
          '#withName':: d.fn(help='"name of the template to include"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { parallel+: { template+: { name: name } } },
        },
        '#withCount':: d.fn(help='"static number of sharded instances to spawn"', args=[d.arg(name='count', type=d.T.any)]),
      ...
      template: {
        '#withConfig':: d.fn(help='"trait configuration values if needed"', args=[d.arg(name='config', type=d.T.object)]),
        withConfig(config): { template+: { config: config } },
        '#withConfigMixin':: d.fn(help='"trait configuration values if needed"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='config', type=d.T.object)]),
        withConfigMixin(config): { template+: { config+: config } },
        '#withName':: d.fn(help='"name of the template to include"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { template+: { name: name } },
      },
      '#use':: d.obj(help='"multiple templates to include in this step"'),
      use: {
        '#withConfig':: d.fn(help='"trait configuration values if needed"', args=[d.arg(name='config', type=d.T.object)]),
        withConfig(config): { config: config },
        '#withConfigMixin':: d.fn(help='"trait configuration values if needed"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='config', type=d.T.object)]),
      ...
      '#withUse':: d.fn(help='"multiple templates to include in this step"', args=[d.arg(name='use', type=d.T.array)]),
      withUse(use): { use: if std.isArray(v=use) then use else [use] },
      '#withUseMixin':: d.fn(help='"multiple templates to include in this step"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='use', type=d.T.array)]),
      withUseMixin(use): { use+: if std.isArray(v=use) then use else [use] },
    ...
    '#use':: d.obj(help='"templates to include at a top-level of workflow"'),
    use: {
      '#withConfig':: d.fn(help='"trait configuration values if needed"', args=[d.arg(name='config', type=d.T.object)]),
      withConfig(config): { config: config },
      '#withConfigMixin':: d.fn(help='"trait configuration values if needed"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='config', type=d.T.object)]),
    ...
    '#withUse':: d.fn(help='"templates to include at a top-level of workflow"', args=[d.arg(name='use', type=d.T.array)]),
    withUse(use): { spec+: { use: if std.isArray(v=use) then use else [use] } },
    '#withUseMixin':: d.fn(help='"templates to include at a top-level of workflow"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='use', type=d.T.array)]),
    withUseMixin(use): { spec+: { use+: if std.isArray(v=use) then use else [use] } },
  },
  '#withDescription':: d.fn(help='"TestWorkflow readable description"', args=[d.arg(name='description', type=d.T.string)]),
  withDescription(description): { description: description },
  '#mixin': 'ignore',
  mixin: self,
}
